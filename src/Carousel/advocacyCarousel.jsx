...
export default function Carousel({ cards }) {
  ...
  return (
    <div className="relative">
      <div ref={scrollRef} className="flex overflow-x-auto gap-4 scroll-smooth py-2 px-8">
        {cards.map((card, idx) => (
          <div
            key={idx}
          ...
          >
            ...
            {card.hasCampaign && (
              <span className="mt-2 bg-red-600 text-white text-xs font-bold px-2 py-1 rounded-full">
                📢 Active Campaign(s)
              </span>
            )}
          </div>
